...
<div id="content">
    ...
    <table class="table table-striped" id="tableCustomer">
        ...
        <tbody>
        <c:forEach items="${serviceList}" var="cus">
            <tr>

                <td><c:out value="${cus.serviceId}"/></td>
                <td><c:out value="${cus.serviceName}"/></td>
                <td><c:out value="${cus.serviceAre}"/></td>
                <td><c:out value="${cus.serviceCost}"/></td>
                <td><c:out value="${cus.serviceMaxPeople}"/></td>
                <td><c:out value="${cus.rentTypeId}"/></td>
                <td><c:out value="${cus.serviceTypeId}"/></td>
                <td><c:out value="${cus.standRoom}"/></td>
                <td><c:out value="${cus.poolArea}"/></td>
                <td><c:out value="${cus.numberFloor}"/></td>
                <td>
                        <%--                                            <a href="/customers?action=delete&id=${cus.customerId}" class="btn btn-danger">Delete</a>--%>
                    <button type="button" class="btn btn-danger" onclick="getIdCustomer('${cus.serviceId}')"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form method="get" action="/services">
                ...
                <input type="hidden" name="idService" id="idCustomer">
