...
<div id="content">
    ...
    <table class="table table-striped" id="tableCustomer">
        ...
        <tbody>
        <c:forEach items="${contractList}" var="cus">
            <tr>

                <td><c:out value="${cus.id}"/></td>
                <td><c:out value="${cus.startDate}"/></td>
                <td><c:out value="${cus.endDate}"/></td>
                <td><c:out value="${cus.deposit}"/></td>
                <td><c:out value="${cus.totalMoney}"/></td>
                <td><c:out value="${cus.employeeId}"/></td>
                ...
                <td>
                    ...
                    <button type="button" class="btn btn-danger" onclick="getIdCustomer('${cus.id}')"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form method="get" action="/contracts">
                ...
                <input type="hidden" name="idContract" id="idCustomer">
