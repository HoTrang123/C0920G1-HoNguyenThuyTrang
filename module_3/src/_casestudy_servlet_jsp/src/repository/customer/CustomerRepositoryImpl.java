...
public class CustomerRepositoryImpl implements CustomerRepository {
    ...
    private static final String INSERT_CUSTOMER_SQL = "INSERT INTO " +
            "customer(customer_type_id, customer_name, customer_birthday,customer_gender," +
...
//                String typeId = resultSet.getString("customer_type_id");
                CustomerType typeId = customerTypeRepository.selectTypeCustomerById(resultSet.getInt("customer_type_id"));
...
//            statement.setString(2,customer.getCustomerTypeId());
            statement.setInt(1, customer.getCustomerTypeId().getId());
