    ...
    <table class="table table-striped" id="tableCustomer">
        ...
        <c:forEach items="${customerList}" var="cus">
            <tr>
                ...
                <td><c:out value="${cus.customer_id_card}"/></td>
                <td><c:out value="${cus.customer_phone}"/></td>
                <td><c:out value="${cus.customer_email}"/></td>
                <td><c:out value="${cus.customer_address}"/></td>
                <td>
                    <a href="/customers?action=edit&id=${cus.customer_id}" class="btn btn-primary">Edit</a>
                    <a href="/customers?action=delete&id=${cus.customer_id}" class="btn btn-danger">Delete</a>
                </td>
            </tr>
        </c:forEach>
        </tbody>
